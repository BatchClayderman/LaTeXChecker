...
class Checker:
	...
	def __selectAnOption(self:object, flag:bool) -> str:
		...
		if isinstance(flag, bool) and flag:
			d = {"B":"Build", "C":"Clear", "D":"Debug", "E":"Exit", "N":"New", "R":"Reload", "S":"Statistics", "T":"Tree"}
			self.__print(																												\
			...
			d = {"B":"Build", "C":"Clear", "D":"Debug", "E":"Exit", "N":"New", "R":"Reload"}
	...
	def __doBuildPDF(self:object) -> bool:
		...
		bRet = all(bRets)
		if bRet:
			self.__print("Successfully built in {0:.9f} second(s). ".format(endTime - startTime), Info)
		else:
			self.__print("Failed to build. The time consumption is {0:.9f} second(s). Details are as follows. ".format(endTime - startTime), Warning)
